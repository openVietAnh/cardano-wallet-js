...
describe("Wallet utilities", function () {
  ...
  const root =
    "xprv15p57eahg2mx0araax2tlc5gulvs20sta28m5f7mj4qs38c7ltpthdxgd4kssvun4frvdraln6ggcu0xmmn3f24z8nf0fvq9sel68qsvxxjny4yawzlwte6ac27yy3ve3vdkykgt082vvjjvqfa2w7kutryxrlgd2";
  const prvKey =
    "ed25519e_sk1rzkp85k5m6afj7es8n3n2nzxd8hrljs7rpat9zv8d9r54a7ltpt398m7vxqr2dkvjdy8y99uxy5f58je735pjv9nf4mhngmll3vcezcrackx0";
  const stakeAddress =
    "stake1uxqchn4lrh63epprnqzm3ges668ahs7qglqjhdxrzuktjwg9mra90";
    ...
    inputs: [
      {
        ...
        address:
          "addr_test1qrqw3p554dtf7sj986u4p76wc9xt2r6dt5n2eqlaask9qhvp308t7804rjzz8xq9hz3np450m0puq37p9w6vx9evhyus0fldvl",
        id: "6b4b99362d807c31a251a575809ac535f4d6440b560d82bc120d07ae10b6e377",
        derivation_path: ["1852H", "1815H", "0H", "1", "0"],
        assets: [],
        index: 0,
      },
      {
        ...
        address:
          "addr_test1qrwwqf0yj50uzxx8yr6gv6lzdcwn8azkfcql4umt5ftty4yp308t7804rjzz8xq9hz3np450m0puq37p9w6vx9evhyusz9fhph",
    ...
    change: [
      {
        ...
        address:
          "addr_test1qqg2rfscx0nmejqegd7vuvmzcep5axjyku7z8rmkj9l7euyp308t7804rjzz8xq9hz3np450m0puq37p9w6vx9evhyuslem9qg",
        derivation_path: ["1852H", "1815H", "0H", "1", "1"],
        assets: [],
      },
    ],
    outputs: [
      {
        ...
        address:
          "addr_test1qq7jm88trfrmcxmzkaycefykk948kjaucmvhah5ph2rzr67km9rcwh70fpz77wjlprw42gjcrnmdu7uuqefhnjanw4xsupazrx",
        assets: [],
      },
    ],
  };
  ...
  const txRawHex =
    "";
  const signedKey =
    "";
  ...
  it("should derive base address from root", function () {
    ...
    const phr =
      "snack skirt gown wage space priority vendor taste diamond calm pulp fatal under swap marble mention gorilla fat debate useless mimic clap curtain orient";
  ...
  it("should return derive stake address from root", function () {
    let rootKey = Seed.deriveRootKey(phrase);
    let stakePrvKey = Seed.deriveKey(rootKey, [
      "1852H",
      "1815H",
      "0H",
      "2",
  ...
  it("should return an enterprise address (no staking)", function () {
    ...
    const address = Seed.getEnterpriseAddress(
      prvKey.to_public(),
      "testnet"
    ).to_bech32();
  ...
  it("should build and sign tx from enterprise address", function () {
    const prvKey = Bip32PrivateKey.from_bech32(
      "xprv14qx5tsmmzyxtlw2tc5g7glc0frkc46nyzgul4yky9keujfk55drjen3s3ley734eg8wldty4e8dgwnxjguu7pra26d3px525ks0q4g38maws6cps6ndck8z8xjkxa2qpmvxq5p68ljy2q5uxmlcxasn57vyz3ppp"
    );
    const coinSelection: CoinSelectionWallet = {
      withdrawals: [] as any[],
      inputs: [
        {
          ...
          address:
            "addr_test1vq38ywnzapcuxf3k9a6xrqerwfazjmyhq6kvx49h0lsddmc8f3v6v",
      ...
      outputs: [
        {
          ...
          address:
            "addr_test1qzp3893hmksaxxkhd75wmftfjwucgeqlyne4cl9az0n0ghnazcna98r9s350vpnyghfsuqk2y29yq88tdcvwm8j0p5dqe0vjam",
          assets: [],
        },
      ],
    };
  ...
  it("should inspect Shelley payment w/stake mainnet address (type 0)", async function () {
    ...
    const pointerInfo = {
      ...
      spending_key_hash:
        "b6dcc337a707351339bf4553dfb903097bb162e52f66903cb5edd5e3",
      spending_key_hash_bech32:
        "addr_vkh1kmwvxda8qu63xwdlg4falwgrp9amzch99anfq094ah27xm6hjuq",
      stake_key_hash:
        "750509b401c96905c740e9b633143909d5078f831a8a57d5e241d4bd",
      stake_key_hash_bech32:
        "stake_vkh1w5zsndqpe95st36qaxmrx9pep82s0rurr299040zg82t63dk2yv",
    };
  ...
  it("should inspect Shelley payment w/stake testnet address (type 0)", async function () {
    ...
    const pointerInfo = {
      ...
      spending_key_hash:
        "76b0d16f5d09ac02dd1786981066f6fedf7ac165a08b3b6f0fb33f03",
      spending_key_hash_bech32:
        "addr_vkh1w6cdzm6apxkq9hghs6vpqehklm0h4st95z9nkmc0kvlsxe7jvdf",
      stake_key_hash:
        "9bf76872ce2fc9debc7c431ce4700ea060a5aefdec0a173d8ed6b426",
      stake_key_hash_bech32:
        "stake_vkh1n0mksukw9lyaa0rugvwwguqw5ps2tthaas9pw0vw666zvnrrh52",
    };
  ...
  it("should inspect Shelley script w/stake mainnet address (type 1)", async function () {
    ...
    const pointerInfo = {
      ...
      address_type: 1,
      network_tag: 1, // mainnet
      spending_shared_hash:
        "c37b1b5dc0669f1d3c61a6fddb2e8fde96be87b881c60bce8e8d542f",
      spending_shared_hash_bech32:
        "addr_shared_vkh1cda3khwqv60360rp5m7akt50m6ttapacs8rqhn5w342z70dxhec",
      stake_key_hash:
      ...
      stake_shared_hash_bech32:
        "stake_shared_vkh1cda3khwqv60360rp5m7akt50m6ttapacs8rqhn5w342z7p6v69g",
    };
  ...
  it("should inspect Shelley payment w/script mainnet address (type 2)", async function () {
    ...
    const pointerInfo = {
      ...
      stake_script_hash_bech32:
        "stake_vkh1cda3khwqv60360rp5m7akt50m6ttapacs8rqhn5w342z7ps3qsu",
    };
  ...
  it("should inspect Shelley script testnet address (type 3)", async function () {
    const addr =
      "addr_test1xqmmnp8sujweq6vc7jkryz9ev96s424e6qhs37mgawkjsaphhxz0peyajp5e3a9vxgytjct4p24tn5p0prak36ad9p6qncrly9";
    const pointerInfo = {
      stake_reference: "by value",
      address_style: "Shelley",
      address_type: 3,
      network_tag: 0, // testnet
      spending_shared_hash:
        "37b984f0e49d906998f4ac3208b961750aaab9d02f08fb68ebad2874",
      spending_shared_hash_bech32:
        "addr_shared_vkh1x7ucfu8ynkgxnx854seq3wtpw5924wws9uy0k68t4558gdx2kmq",
      stake_script_hash:
        "37b984f0e49d906998f4ac3208b961750aaab9d02f08fb68ebad2874",
      stake_script_hash_bech32:
        "stake_vkh1x7ucfu8ynkgxnx854seq3wtpw5924wws9uy0k68t4558grmapjy",
      stake_shared_hash:
        "37b984f0e49d906998f4ac3208b961750aaab9d02f08fb68ebad2874",
      stake_shared_hash_bech32:
        "stake_shared_vkh1x7ucfu8ynkgxnx854seq3wtpw5924wws9uy0k68t4558gr3qm8s",
    };
  ...
  it("should inspect Byron mainnet address (type 8)", async function () {
    const addr =
      "DdzFFzCqrht8CHL4tkQy82G6iPk8rsNSpFtqHT6HgR727PrD4meHJAa5z8JkHUHAt3uL1kmtgxUNitnUUomqwmdjgHM3wfzmhDsTf4YT";
    const byronInfo = {
      stake_reference: "none",
      address_style: "Byron",
      address_type: 8,
      ...
      derivation_path:
        "581c4dd5b9b8042c24a1dbfb484ba577d24651557fb77bf6a8fdeed3be72",
    };
  ...
  it("should inspect Byron testnet address (type 8)", async function () {
    ...
    const byronInfo = {
      ...
      derivation_path:
        "581c9c1722f7e446689256e1a30260f3510d558d99d0c391f2ba89cb6977",
    };
  ...
  it("should inspect Icarus testnet address (type 8)", async function () {
    const addr =
      "2cWKMJemoBahmgvHu12VNW64Z65qMJfhyqaUbNNpjntXMzMpRCwPJkZvia4TzhzYFsZhn";
    const icarusInfo = {
      stake_reference: "none",
      address_style: "Icarus",
      address_type: 8,
  ...
  it("should throw invalid address", async function () {
    const addr =
      "2cWKMJemoBahmgvHu12VNW64Z65qMJfhyqaUbNNpjpepetXMzMpRCwPJkZvia4TzhzYFsZhn";
  ...
  it("should match script key hash and signing key hash", function () {
    const hash = Buffer.from(
      Seed.getKeyHash(
        Bip32PrivateKey.from_bech32(scriptKeys[0]).to_public()
      ).to_bytes()
    ).toString("hex");
  ...
  it("should build a multisig tx", function () {
    const signingKeys = scriptKeys.map((key) =>
      Bip32PrivateKey.from_bech32(key).to_raw_key()
    );
    const script = Seed.buildScript(jsonScript);
    let buildOpts = {
      startSlot: 0,
      ...
      outputs: [
        {
          ...
          address:
            "addr_test1qpc6srdq6jjt6eetstw6t4elmypvepa6ykxcps3dvvv4fr5ca6s0m36w9nlk7ntwdhvhxeyz9u4lngn97fcv4ykjqc2sk4hrgy",
          assets: [],
        },
      ],
      change: [
    ...
    let tx = Seed.buildTransactionMultisig(
      selection,
      ttl,
      scripts,
      null,
      ...
      inputs: [
        {
          ...
          address:
            "addr_test1xzfyhp0089dlvcvqg2gq3grwd6uu0yfhxpaxa0np4smwjavjfwz77w2m7escqs5spzsxum4ec7gnwvr6d6lxrtpka96ssvtdj5", // script address
      ...
      change: [
        {
          ...
          address:
            "addr_test1xzfyhp0089dlvcvqg2gq3grwd6uu0yfhxpaxa0np4smwjavjfwz77w2m7escqs5spzsxum4ec7gnwvr6d6lxrtpka96ssvtdj5",
          assets: [],
        },
      ],
      outputs: [
        {
          ...
          address:
            "addr_test1qznup567ujylt54wecqtknc2tlp5htaw2ywghh0dcxtxtz6r5gtdwq4yajng57kje93tt3fkc5k8cvvem7vl8yql2mcsn3hwwk",
          assets: [],
        },
      ],
    };
  ...
  it("should parse transaction witness set", function () {
    const cbor =
      "";

    const tx = Buffer.from([
      132, 167, 0, 130, 130, 88, 32, 70, 8, 50, 173, 127, 146, 0, 13, 118, 128,
      150, 111, 100, 205, 188, 100, 215, 202, 102, 43, 239, 37, 115, 169, 225,
      55, 177, 122, 105, 142, 167, 0, 0, 130, 88, 32, 123, 28, 24, 174, 128,
      129, 244, 135, 24, 208, 175, 145, 21, 29, 40, 170, 52, 142, 24, 29, 135,
      111, 105, 80, 143, 164, 193, 156, 183, 65, 172, 3, 0, 1, 132, 130, 88, 57,
      0, 19, 169, 105, 86, 185, 250, 111, 76, 99, 159, 146, 72, 101, 225, 30,
      158, 178, 241, 94, 118, 33, 231, 37, 161, 80, 104, 205, 102, 193, 84, 81,
      65, 13, 112, 226, 246, 64, 128, 170, 197, 239, 153, 182, 227, 47, 170,
      108, 209, 171, 56, 209, 46, 96, 160, 43, 246, 130, 26, 0, 22, 155, 8, 161,
      88, 28, 241, 11, 57, 200, 158, 161, 140, 209, 243, 39, 215, 228, 6, 246,
      135, 151, 43, 253, 108, 9, 243, 2, 151, 34, 51, 0, 10, 208, 161, 80, 84,
      97, 110, 103, 111, 99, 114, 121, 112, 116, 111, 67, 73, 80, 51, 48, 1,
      130, 88, 57, 0, 75, 185, 121, 147, 204, 205, 86, 20, 183, 119, 132, 180,
      129, 241, 159, 155, 189, 242, 65, 66, 254, 68, 202, 247, 207, 202, 237,
      122, 118, 242, 185, 15, 255, 25, 114, 158, 121, 233, 228, 217, 106, 108,
      5, 105, 26, 8, 190, 18, 157, 11, 131, 77, 80, 202, 60, 145, 26, 0, 23, 43,
      184, 130, 88, 57, 0, 113, 168, 13, 160, 212, 164, 189, 103, 43, 130, 221,
      165, 215, 63, 217, 2, 204, 135, 186, 37, 141, 128, 194, 45, 99, 25, 84,
      142, 152, 238, 160, 253, 199, 78, 44, 255, 111, 77, 110, 109, 217, 115,
      100, 130, 47, 43, 249, 162, 101, 242, 112, 202, 146, 210, 6, 21, 26, 0,
      30, 132, 128, 130, 88, 57, 0, 19, 169, 105, 86, 185, 250, 111, 76, 99,
      159, 146, 72, 101, 225, 30, 158, 178, 241, 94, 118, 33, 231, 37, 161, 80,
      104, 205, 102, 193, 84, 81, 65, 13, 112, 226, 246, 64, 128, 170, 197, 239,
      153, 182, 227, 47, 170, 108, 209, 171, 56, 209, 46, 96, 160, 43, 246, 26,
